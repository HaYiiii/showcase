...
export function ActionButton({
  ...
  const base =
    "inline-flex items-center justify-center gap-2 rounded-2xl px-4 py-2 text-[13px] font-semibold transition will-change-transform active:translate-y-[1px] pointer";
